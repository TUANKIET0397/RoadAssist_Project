  ...
  Future<void> _showTimeRangePicker(
    ...
    await showDialog(
      ...
      builder: (context) => _TimeRangePickerDialog(
        ...
        onSave: (open, close) {
          ref.read(garageProvider.notifier).updateGarage(
                garage.copyWith(
        ...
        InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: const Color.fromRGBO(25, 37, 59, 1), // Dark blue background
              borderRadius: BorderRadius.circular(12),
              border: Border.all(
                color: const Color.fromRGBO(127, 199, 252, 1), // Light blue border
                width: 1.5,
              ),
            ),
            child: Row(
