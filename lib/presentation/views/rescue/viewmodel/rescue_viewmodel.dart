...
StreamProvider.family.autoDispose<List<RescueRequestModel>, String>(
        (ref, userId) {
      final repo = ref.watch(rescueRequestRepoProvider);
      return repo.getUserRequestsStream(userId);
    });

final rescueNearbyProvider =
FutureProvider.family.autoDispose<List<RescueRequestModel>, Map<String, double>>(
        (ref, loc) {
      final repo = ref.watch(rescueRequestRepoProvider);
