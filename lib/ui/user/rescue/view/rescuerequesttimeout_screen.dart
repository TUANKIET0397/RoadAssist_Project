...
import 'package:road_assist/ui/user/rescue/viewmodel/rescuerequesttimeout_vm.dart';
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFF2C3E50), Color(0xFF34495E), Color(0xFF2980B9)],
          ),
        ),
        child: SafeArea(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [Colors.transparent, Color(0xFF1A2634).withOpacity(0.95)],
        ),
      ),
      child: SafeArea(
        top: false,
