...
import 'package:road_assist/domain/entities/user.dart';
...
class ProfileViewModel extends ChangeNotifier {
  ...
  void _loadProfile() {
    ...
    _profile = User(
      ...
      isVerified: true, password: 'examplePassword123',
    );
  ...
  void saveProfile() {
    _profile = User(
      ...
      isVerified: _profile.isVerified, password: 'examplePassword123',
    );
