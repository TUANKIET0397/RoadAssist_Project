...
// import 'package:road_assist/ui/viewmodels/chat/chat_viewmodel.dart';
...
// import 'package:road_assist/ui/chat/widgets/triangle_gradient_painter.dart';
...
//                 0, // Ngăn AppBar đổi màu khi có nội dung cuộn bên dưới
//             surfaceTintColor:
//                 Colors.transparent, // Đảm bảo không bị ám màu theo Material 3
//             leading: IconButton(
...
//                       Color(
//                         0x33FFFFFF,
//                       ), // Trắng với opacity thấp (Overlay effect)
...
//                     color: const Color(
//                       0xFF242C3B,
//                     ), // Cùng màu với background AppBar
...
//                             double opacity =
//                                 ((offset - appearancePoint + 500) / 500).clamp(
//                                   0.0,
//                                   0.4,
//                                 );
...
//                               top: isLeft
//                                   ? 60
//                                   : 380, // Các vị trí cố định so le trên màn hình
