    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        onPressed: state.isLoading
            ...
            : () async {
                try {
                  await ref.read(garageProvider.notifier).saveGarage(userId: userId);
                  if (context.mounted) {
                  ...
                  if (context.mounted) {
                    ...
                    if (e.toString().contains('permission') || 
                      ...
                      errorMessage = 'Lỗi quyền truy cập! Kiểm tra Firestore Rules trong Firebase Console.';
                    } else if (e.toString().contains('network') || 
                               e.toString().contains('UNAVAILABLE')) {
                      errorMessage = 'Lỗi kết nối mạng! Kiểm tra internet connection.';
                    } else if (e.toString().contains('not-found')) {
                      errorMessage = 'Collection không tồn tại. Đang tự động tạo...';
                    } else {
