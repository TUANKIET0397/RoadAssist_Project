      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: widget.garage.vehicleTypes.map((e) => _buildChip(e)).toList(),
          ),
        ],
      ),
    );
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                    child: Text(widget.garage.address,
          ...
          Row(
            children: [
              Expanded(
                  child: _buildOutlinedButton('Chỉ Đường', Icons.navigation, () {})),
              const SizedBox(width: 12),
              Expanded(
                  child: _buildOutlinedButton(
                      'Gọi Garage', Icons.phone_in_talk, () {})),
            ],
          ),
        ],
      ),
              ...
              children: widget.garage.services
                  .map((s) => RichText(
                        text: TextSpan(children: [
                          const TextSpan(
                              text: '• ', style: TextStyle(color: Colors.blue, fontSize: 18)),
                          TextSpan(
                              text: s,
                              style: const TextStyle(color: Colors.white, fontSize: 14)),
                        ]),
              ...
              children: [
                Row(
                  children: [
                    ...
                    Text(time,
                        style: const TextStyle(
                            color: Color(0xFF2FB8FF), fontSize: 11)),
                  ],
                ),
